...
SOURCEFILES_QUOTED_IF_SPACED=mainPostLab8.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mainPostLab8.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/mainPostLab8.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mainPostLab8.p1

# Source Files
SOURCEFILES=mainPostLab8.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/mainPostLab8.p1: mainPostLab8.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mainPostLab8.p1.d 
	@${RM} ${OBJECTDIR}/mainPostLab8.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/mainPostLab8.p1 mainPostLab8.c 
	@-${MV} ${OBJECTDIR}/mainPostLab8.d ${OBJECTDIR}/mainPostLab8.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mainPostLab8.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
